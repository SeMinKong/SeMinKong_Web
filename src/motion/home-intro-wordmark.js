...
export const INTRO_WORDMARK_STROKES = [
  {
    letter: 'S',
    strokes: [
      { d: 'M116 39 C96 20 55 23 38 48 C22 72 46 91 78 97 C111 103 126 121 111 145 C94 170 48 168 25 141' }
    ]
  },
  {
    letter: 'e',
    strokes: [
      { d: 'M136 108 C157 108 188 103 192 85 C196 67 178 58 159 63 C139 68 130 91 135 114 C141 140 170 153 200 138' }
    ]
  },
  {
    letter: 'M',
    strokes: [
      { d: 'M256 155 L259 35 L312 112 L366 34 L369 155' }
    ]
  },
  {
    letter: 'i',
  ...
  },
  {
    letter: 'n',
    strokes: [
      { d: 'M425 155 L425 84 C425 107 441 82 465 82 C486 82 497 97 497 120 L497 155' }
    ]
  },
  {
    letter: 'K',
  ...
  },
  {
    letter: 'o',
    strokes: [
      { d: 'M735 82 C710 82 693 98 693 120 C693 142 710 157 734 157 C759 157 774 140 774 119 C774 96 759 82 735 82 Z' }
    ]
  },
  {
    letter: 'n',
    strokes: [
      { d: 'M794 155 L794 84 C794 107 810 82 834 82 C855 82 866 97 866 120 L866 155' }
    ]
  },
  {
    letter: 'g',
    strokes: [
      { d: 'M930 83 C906 83 890 99 890 120 C890 142 907 156 930 156 C953 156 966 140 966 119 C966 96 953 83 930 83 Z L966 84 L966 153 C966 178 950 188 928 181' }
    ]
  }
];

const createHandwrittenWordmark = () => {
  const wordmark = document.createElementNS(SVG_NAMESPACE, 'svg');
  wordmark.classList.add('handwritten-wordmark', 'hero-identity__wordmark');
  ...
  INTRO_WORDMARK_STROKES.forEach(({ strokes }) => {
...
export const mountHeroWordmark = (heroName) => {
  ...
  const wordmark = createHandwrittenWordmark();
