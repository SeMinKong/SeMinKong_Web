...
export const SNAP_DWELL = 40;
export const SNAP_DURATION = 140;
export const getSnapTuning = (coarsePointer, interactionScale) => ({
  distance: (coarsePointer ? 58 : 52) * interactionScale,
  angle: (coarsePointer ? 40 : 35) * Math.PI / 180,
  hintDistance: (coarsePointer ? 80 : 72) * interactionScale,
