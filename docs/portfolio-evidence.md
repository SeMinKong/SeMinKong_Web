...
A4 landscape, 20 pages: introduction / About / index (1–3); THING integration, source architecture, physical variation and demonstration / award (4–7); AQIS integration, initial hardware constraint, coordinate timing and verification boundaries (8–11); Briefit contribution / three awards and quality tradeoffs (12–13); MRI inference and evaluation boundaries (14–15); Prompt overview and domain state / revision limits (16–17); Alkkagi overview and server-owned state (18–19); contact (20). The owner requested this exact project order and an introduction page at the start of every project. The opening two pages contain no project names or project-linked awards. Publication follows the standing GitHub Pages authorization after PDF and website verification.
