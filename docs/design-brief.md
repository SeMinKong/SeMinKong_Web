...
## 2026-09-04 — Static portfolio typography and portrait refinement

- Preserve the 20-page structure, fonts, copy, original project media and diagrams. Correct short paragraph tails with whole-word wrapping and local semantic line breaks; do not shrink the font to make text fit.
...
- Place the owner's requested original portrait only on the PDF introduction page, without cropping or retouching. Align the portrait to the right-column start and arrange the existing personal facts beneath it. Keep the standalone portrait in ignored private storage; do not add it to website markup, public assets or the public repository.
