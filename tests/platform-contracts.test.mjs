...
test('the reviewed static portfolio is downloadable without exposing working files', async () => {
  ...
  assert.match(resume, /26 pages · A4 landscape · PDF · 15\.9 MB · 2026\.09\.08/);
  ...
  assert.equal(pdf.length, 15851027);
  assert.equal(
    await sha256Of('public/portfolio/SeMinKong-Portfolio.pdf'),
    'CD0A46D2661D40897916B219400184A7744FBFAC9FA9FBF72CC56116B0EFE933',
