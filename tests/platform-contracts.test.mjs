...
test('the reviewed static portfolio is downloadable without exposing working files', async () => {
  ...
  assert.match(resume, /20 pages · A4 landscape · PDF · 15\.2 MB · 2026\.09\.07/);
  ...
  assert.equal(pdf.length, 15189951);
  assert.equal(
    await sha256Of('public/portfolio/SeMinKong-Portfolio.pdf'),
    'A519FB83E3D55A75F954A038453A664179B0FB6F378FB34066A0612FD05AEB32',
